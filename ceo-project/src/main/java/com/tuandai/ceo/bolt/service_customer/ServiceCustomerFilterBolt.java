...
public class ServiceCustomerFilterBolt implements IBasicBolt {
    @Override
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("customer_name", "profession"));
    }
